...
const DepthText = ({
  ...
  return (
    <span ref={rootRef} className={`depth-text-root ${className}`.trim()} style={{ ...rootStyle, display: 'inline-block' }}>
      <span ref={stageRef} className="depth-text-stage" style={{ ...stageStyle, position: 'relative', display: 'inline-grid', placeItems: 'center' }}>
